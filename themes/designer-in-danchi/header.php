...
<head>
  <title>団地のDesignerのポートフォリオ | Webデザイナー | 東京都</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="団地のデザイナーのポートフォリオサイトです。Webデザイン、UI/UXデザインを中心に、これまでの実績やスキルを紹介しています。お仕事のご依頼・ご相談はお気軽にお問い合わせください。">
...
<body class="fadein">
  ...
  <header class="position-fixed w-100 p-3 <?php echo $page_title; ?> <?php echo $bg; ?>">
    <div class="d-flex flex-wrap px-lg-4">
      ...
      <!--hide lg-->
      <div class="button_container lg-hide" id="toggle"><span class="top"></span><span class="middle"></span><span class="bottom"></span></div>
