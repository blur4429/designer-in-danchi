...
<main>
    <div class="pagetitle container-fluid d-md-flex flex-md-wrap align-items-end px-3 px-lg-5 pb-3 bg-blue">
        <h1 id="fade-title" class="me-4 mb-2 mb-md-0">Works</h1>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-scale px-3 px-lg-0">
                    ...
                    <div class=" col px-3 mb-5">
                        <a href="https://willof-construction.co.jp/" target="_blank">
                            ...
                            <p class="smaller pt-2">willof-construction.jp</p>
                    ...
                    <div class=" col px-3 mb-5">
                        <a href="https://start.willof-construction.co.jp/" target="_blank">
                            ...
                            <p class="smaller pt-2">start.willof-construction.co.jp</p>
                    ...
                    <div class=" col px-3 mb-5">
                        <a href="https://sekokan-navi.jp/saiyo/" target="_blank">
                            ...
                            <p class="smaller pt-2">sekokan-navi.jp/saiyo</p>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-scale px-3 px-lg-0">
                    ...
                    <div class=" col px-3 mb-5">
                        <a href="https://sekokan-navi.jp/registration_form/" target="_blank">
                            ...
                            <p class="smaller pt-2">施工管理経験者が選ぶサイトNo.1
                            </p>
                    ...
                    <div class=" col px-3 mb-5">
                        <a href="https://sekokan-navi.jp/saiyo_sekoukanri" target="_blank">
                            ...
                            <p class="smaller pt-2">今すぐ採用するなら施工管理求人ナビ
                            </p>
                            <span class="x-small gray2">Design / Cording</span>
                        </a>
                    </div>
                    ...
                    <div class=" col px-3 mb-5">
                        ...
                        <p class="smaller pt-2">建設業界で市場価値を上げる(closed)</p>
                        <span class="x-small gray2">Design / Cording</span>
                    </div>

                    <div class=" col px-3 mb-5">
                        <a href="https://sekokan-navi.jp/sekoukanri_agent/?utm_source=media&utm_medium=banner&utm_campaign=agent"
                            target="_blank">
                            <img src="<?php echo $url; ?>/img/lp/works_lp3.jpg" alt="lp3">
                            <p class="smaller pt-2">正社員転職なら施工管理求人ナビへ
                            </p>
                    ...
                    <div class=" col px-3 mb-5">
                        ...
                        <p class="smaller pt-2">仕事探しならウィルオブ(closed)
                        </p>
                        <span class="x-small gray2">Design / Cording</span>
                    </div>
                    ...
                    <div class=" col px-3 mb-5">
                        ...
                        <p class="smaller pt-2">カレーなる施工管理人生(closed)
                        </p>
                        <span class="x-small gray2">Design / Cording</span>
                    </div>
                    ...
                    <div class=" col px-3 mb-5">
                        ...
                        <p class="smaller pt-2">施工にほえろ！(closed)
                        </p>
                        <span class="x-small gray2">Design / Cording</span>
                    </div>
                    ...
                    <div class=" col px-3 mb-5">
                        <a href="/l-page/accede/" target="_blank">
                            ...
                            <p class="smaller pt-2">デジタルハリウッドweb課題
                            </p>
                            <span class="x-small gray2">Design / Cording</span>
                        </a>
                    </div>
                ...
                <div class="row" data-masonry="{&quot;percentPosition&quot;: true }">
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                data-bs-target="#Modal1">
                                <img src="<?php echo $url; ?>/img/works/other1.jpg" width="595" height="842"
                                    alt="other1">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">2024夏 JAPAN BUILD
                                    </p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other2.jpg" width="1024" height="562"
                                    alt="other2">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">2023冬 JAPAN BUILD
                                    </p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other3.jpg" width="595" height="842"
                                    alt="other3">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">2022年秋 JAPAN BUILD
                                    </p>
                                    <span class="x-small gray2">A4フライヤー<br>Design</span>
                                </div>
                            </a>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other4.jpg" width="595" height="842"
                                    alt="other4">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">2023冬 JAPAN BUILD
                                    </p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other5.jpg" width="595" height="842"
                                    alt="other5">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">建設業に特化した人材派遣、紹介、メディアサービス
                                    </p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other6.jpg" width="595" height="842"
                                    alt="other6">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">採用にお悩みの皆様へ
                                    </p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other7.jpg" width="1024" height="562"
                                    alt="other7">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">カレーなる施工管理人生</p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other8.jpg" width="595" height="842"
                                    alt="other8">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">元気をありがとう!プロジェクト
                                    </p>
                                    <span class="x-small gray2">Yahoo!協賛イベント A3カタログ<br>Design</span>
                                </div>
                            </a>
                        </div>
                        <!-- 8-Modal -->
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                ...
                                <img src="<?php echo $url; ?>/img/works/other9.jpg" width="595" height="842"
                                    alt="other9">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">施工管理の志士たちよ、今こそ沿岸部に力を!
                                    </p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a class="g-scale" href="https://sekokan-navi.jp/magazine/interview_writer_recruit"
                                target="_blank">
                                <img src="<?php echo $url; ?>/img/works/other10.jpg" width="1024" height="562"
                                    alt="other10">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">取材ライター募集
                                    </p>
                                    <span class="x-small gray2">施工の神様<br>Writing / Design</span>
                                </div>
                            </a>
                        </div>
                    </div>

                    <!--works_other11 202405-->
                    <div class="col-sm-6 col-lg-4 mb-4">
                        <div class="card bg-light p-3">
                            <a type="button" class="btn border-0 text-start g-scale" data-bs-toggle="modal"
                                data-bs-target="#Modal11">
                                <img src="<?php echo $url; ?>/img/works/other11.jpg" width="1024" height="562"
                                    alt="other11">
                                <div class="card-body p-0">
                                    <p class="smaller pt-2">BIM TO JAPAN
                                    </p>
                                    <span class="x-small gray2">ロゴ制作<br>Design</span>
                                </div>
                            </a>
                        </div>
                        <!-- 11-Modal -->
                        <div class="modal fade" id="Modal11" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable-y">
                                <div class="modal-content border-0">
                                    <img src="<?php echo $url; ?>/img/works/bimtojapan.jpg" alt="other11">
                                </div>
                            </div>
                        </div>
                    </div>
